...
<head>
    ...
    <style>
        body {
            background-image: url("${pageContext.request.contextPath}/Images/registeration_background.jpg");
                    ...
                    <div id="instructorFields" style="display: none;">
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <select id="instructorDepartment" name="instructorDepartment" class="form-control form-control-lg">
                                ...
                                <% System.out.println("Department Name: " + department.getName() + " " +  department.getId()); %>
